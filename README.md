...
On the Sportlots **Orders - Paid** page (`https://sportlots.com/s/ui/paid.html`), every order row gets a small `Neonbinder: 1 oz | 2 oz | 3 oz` button group under the order number. Clicking a weight:
